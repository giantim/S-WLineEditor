...
****************************************************************************/
{
   ...
   DLL kwList;
   boolean YankRun = false;
   boolean MarginRun = false;
   ...
   public void Cmd_F(File_Buffer FILE, int nLines, String findstr)
   {
       ...
       if (MarginRun)
       {
    	   start = (Margin_Left >= CLN) ? Margin_Left : CLN;
    	   end = Margin_Right;
       }
       else
       {
   ...
   public void Cmd_R(File_Buffer FILE, int nLines, String strF, String strT)
   {
       ...
       if (MarginRun)
       {
    	   startRep = (Margin_Left >= CLN) ? Margin_Left : CLN;
    	   endCLN = Margin_Right;
       }
       else
       {
       ...
       for(line_no=startRep; line_no<=endCLN; line_no++) 
       {
